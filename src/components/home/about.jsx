      ...
      <div className="about-wrapper">
        ...
        <div className="content">
          ...
          <p className="about-text-content">
            As a career shifter, my adaptability to new technologies and frameworks is a key strength, honed through
            bootcamp training. I have solid experience with the MERN stack and in building full-stack web applications.
            My passion for continuous learning and creating efficient solutions makes me a valuable asset ready to
